...
export function createUI() {
  ...
  return {
    ...
    unitResistanceStat: document.querySelector(".unit-resistance-stat"),
    unitSkillStat: document.querySelector(".unit-skill-stat"),
    unitLuckStat: document.querySelector(".unit-luck-stat"),
    unitSpeedStat: document.querySelector(".unit-speed-stat"),
